...
const DatasetsDashboard: NextPage = () => {
  ...
  useLayoutEffect(() => {
    if (portalData) {
      const isIndeterminate =
        ...
        selectedDatasets.length < portalData.datasets.length;
      setChecked(selectedDatasets.length === portalData.datasets.length);
  ...
  function toggleAll() {
    if (portalData) {
      setSelectedDatasets(checked || indeterminate ? [] : portalData.datasets);
                  ...
                  <div className="ring-1 ring-gray-300 sm:mx-0 sm:rounded-lg">
                    <table className="min-w-full table-fixed divide-y divide-gray-300">
                      ...
                      <tbody className="divide-y divide-gray-200 bg-white">
                        {portalData.datasets.map((dataset) => (
                          <tr
                            key={dataset.name}
                            className={
